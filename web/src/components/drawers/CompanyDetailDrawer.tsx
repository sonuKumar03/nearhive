        ...
        <div className="space-y-2.5">
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div className="p-2.5 rounded-lg bg-slate-950 border border-slate-800/80 space-y-1">
              ...
              <p className="font-medium text-slate-200">{company.industry || details?.industry || 'Technology'}</p>
            </div>
            <div className="p-2.5 rounded-lg bg-slate-950 border border-slate-800/80 space-y-1">
              <span className="text-[10px] text-slate-500">Employees</span>
              <p className="font-medium text-slate-200">{company.employee_count || details?.employee_count || '100 - 500'}</p>
            </div>
          </div>
          {(company.domain || details?.domain) && (
            <div className="p-2.5 rounded-lg bg-slate-950 border border-slate-800/80 flex items-center justify-between text-xs">
              ...
              <a
                href={`https://${company.domain || details?.domain}`}
                target="_blank"
                rel="noreferrer"
